...
void main()
{  
    vec3 ambientLightIntensity = vec3(0.11, 0.24, 0.24);
    vec3 moonLightIntensity = vec3(0.12, 0.18, 0.45);
    vec3 sunLightIntensity = vec3(0.77, 0.57, 0.17);
    //directional light
    vec3 sunLightDirection = normalize(vec3(-10.0, 10.0, -7.0));
    ...
    vec3 lightIntensity = ambientLightIntensity+
        sunLightIntensity*max(dot(step(0.3, v_fragNormal), sunLightDirection), 0.4)
        +moonLightIntensity*max(dot(step(0.3, v_fragNormal), moonLightDirection), 0.6);
