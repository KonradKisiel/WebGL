...
*/
GL.attachShader(PROGRAM, initShader(GL, GL.VERTEX_SHADER, document.getElementById("vertexShaderText").value));
GL.attachShader(PROGRAM, initShader(GL, GL.FRAGMENT_SHADER, document.getElementById("fragmentShaderText").value));
